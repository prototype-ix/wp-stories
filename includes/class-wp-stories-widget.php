...
class Widget extends Widget_Base {
	...
	private function build_story_data( array $story, $idx ) {
		...
		// ── Slides ───────────────────────────────────────────────────────────
		$slides = [];
		$image_fit = $story['image_fit'] ?? 'cover';
		if ( ! in_array( $image_fit, [ 'cover', 'contain', 'scale-down' ], true ) ) {
			$image_fit = 'cover';
		}
	...
	protected function register_controls() {
			...
			'raw'  => '<button type="button" class="wps-preview-btn"
				...
				onclick="(function(btn){
					...
					if (imgs.length) {
						...
						imgEl.src = imgs[0];
						imgEl.style.cssText = \'width:100%;height:220px;object-fit:cover;object-position:center;display:block;background:#111;\';
		...
		$repeater->add_control( 'avatar', [
			...
			'description' => esc_html__( 'For the best result, use a square 1:1 image.', 'wp-stories' ),
		...
		$repeater->add_control( 'image_fit', [
			...
			'options' => [
				...
				'scale-down' => esc_html__( 'Scale down (no stretch)', 'wp-stories' ),
			],
		] );

		// ── Link Button ───────────────────────────────────────────────────────
		$repeater->add_control( 'link_heading', [
			'label'     => esc_html__( '── Link Button', 'wp-stories' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );

		$repeater->add_control( 'link_enable', [
			'label'   => esc_html__( 'Enable link', 'wp-stories' ),
			'type'    => Controls_Manager::SWITCHER,
			'default' => '',
		] );

		$repeater->add_control( 'link_url', [
			'label'       => esc_html__( 'Destination URL', 'wp-stories' ),
		...
		$repeater->add_control( 'link_text', [
			'label'     => esc_html__( 'Button Text', 'wp-stories' ),
			'type'      => Controls_Manager::TEXT,
			'default'   => '',
			'condition' => [ 'link_enable' => 'yes' ],
		] );
		...
		$repeater->add_control( 'link_icon', [
			'label'     => esc_html__( 'Icon', 'wp-stories' ),
		...
		$repeater->add_control( 'link_pos_y', [
			'label'       => esc_html__( 'Vertical Position (%)', 'wp-stories' ),
			'description' => esc_html__( '0 = top · 100 = bottom · 85 = near the bottom', 'wp-stories' ),
		...
		$repeater->add_control( 'link_text_color', [
			'label'     => esc_html__( 'Text Color', 'wp-stories' ),
		...
		$repeater->add_control( 'link_bg_color', [
			'label'     => esc_html__( 'Button Background', 'wp-stories' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '#ffffff',
			'condition' => [ 'link_enable' => 'yes' ],
		] );
		...
		$repeater->add_control( 'link_border_color', [
			'label'     => esc_html__( 'Border Color', 'wp-stories' ),
			'type'      => Controls_Manager::COLOR,
		...
		$repeater->add_control( 'link_border_width', [
			'label'     => esc_html__( 'Border Width (px)', 'wp-stories' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$repeater->add_control( 'link_border_radius', [
			'label'     => esc_html__( 'Border Radius (px)', 'wp-stories' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$repeater->add_control( 'link_font_size', [
			'label'     => esc_html__( 'Font Size (px)', 'wp-stories' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$repeater->add_control( 'link_font_weight', [
			'label'     => esc_html__( 'Font Weight', 'wp-stories' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => '600',
			'options'   => [
		...
		$repeater->add_control( 'link_padding_v', [
			'label'     => esc_html__( 'Vertical Padding (px)', 'wp-stories' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$repeater->add_control( 'link_padding_h', [
			'label'     => esc_html__( 'Horizontal Padding (px)', 'wp-stories' ),
			'type'      => Controls_Manager::SLIDER,
			'range'     => [ 'px' => [ 'min' => 0, 'max' => 60 ] ],
		...
		$repeater->add_control( 'link_target', [
			'label'     => esc_html__( 'Open In', 'wp-stories' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => '_blank',
			'options'   => [ '_blank' => esc_html__( 'New tab', 'wp-stories' ), '_self' => esc_html__( 'Same tab', 'wp-stories' ) ],
			'condition' => [ 'link_enable' => 'yes' ],
		] );

		// ── Text Overlay ──────────────────────────────────────────────────────
		$repeater->add_control( 'text_overlay_heading', [
			'label'     => esc_html__( '── Text Overlay', 'wp-stories' ),
			'type'      => Controls_Manager::HEADING,
			'separator' => 'before',
		] );

		$repeater->add_control( 'text_overlay_enable', [
			'label'   => esc_html__( 'Enable text', 'wp-stories' ),
			'type'    => Controls_Manager::SWITCHER,
			'default' => '',
		] );

		$repeater->add_control( 'text_overlay_content', [
			'label'     => esc_html__( 'Content (HTML allowed)', 'wp-stories' ),
		...
		$repeater->add_control( 'text_overlay_pos_x', [
			'label'       => esc_html__( 'X Position (%)', 'wp-stories' ),
			'description' => esc_html__( '0 = left · 50 = center · 100 = right', 'wp-stories' ),
			'type'        => Controls_Manager::SLIDER,
			'range'       => [ 'px' => [ 'min' => 0, 'max' => 100 ] ],
			'default'     => [ 'size' => 50 ],
			'condition'   => [ 'text_overlay_enable' => 'yes' ],
		...
		$repeater->add_control( 'text_overlay_pos_y', [
			'label'       => esc_html__( 'Y Position (%)', 'wp-stories' ),
			'description' => esc_html__( '0 = top · 100 = bottom', 'wp-stories' ),
			'type'        => Controls_Manager::SLIDER,
			'range'       => [ 'px' => [ 'min' => 0, 'max' => 100 ] ],
			'default'     => [ 'size' => 50 ],
			'condition'   => [ 'text_overlay_enable' => 'yes' ],
		...
		$repeater->add_control( 'text_overlay_origin_x', [
			'label'     => esc_html__( 'Horizontal Anchor', 'wp-stories' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => 'center',
			'options'   => [
				'left'   => esc_html__( 'Left edge of the container', 'wp-stories' ),
				'center' => esc_html__( 'Center of the container', 'wp-stories' ),
				'right'  => esc_html__( 'Right edge of the container', 'wp-stories' ),
			],
			'condition' => [ 'text_overlay_enable' => 'yes' ],
		] );

		$repeater->add_control( 'text_overlay_width', [
			'label'      => esc_html__( 'Container Width', 'wp-stories' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [ '%', 'px' ],
		...
		$repeater->add_control( 'text_overlay_min_height', [
			'label'     => esc_html__( 'Minimum Height (px, 0 = auto)', 'wp-stories' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$repeater->add_control( 'text_overlay_bg', [
			'label'     => esc_html__( 'Container Background', 'wp-stories' ),
			'type'      => Controls_Manager::COLOR,
			'default'   => '',
			'condition' => [ 'text_overlay_enable' => 'yes' ],
		] );
		...
		$repeater->add_control( 'text_overlay_text_align', [
			'label'     => esc_html__( 'Text Alignment', 'wp-stories' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => 'center',
			'options'   => [ 'left' => esc_html__( 'Left', 'wp-stories' ), 'center' => esc_html__( 'Center', 'wp-stories' ), 'right' => esc_html__( 'Right', 'wp-stories' ) ],
			'condition' => [ 'text_overlay_enable' => 'yes' ],
		] );

		$repeater->add_control( 'text_overlay_line_height', [
			'label'     => esc_html__( 'Line Height', 'wp-stories' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$repeater->add_control( 'text_overlay_letter_spacing', [
			'label'     => esc_html__( 'Letter Spacing (px)', 'wp-stories' ),
			'type'      => Controls_Manager::SLIDER,
		...
		$this->add_responsive_control( 'circle_size', [
			...
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [ 'px' ],
			'range'      => [ 'px' => [ 'min' => 40, 'max' => 260, 'step' => 2 ] ],
			'default'    => [ 'unit' => 'px', 'size' => 100 ],
			'tablet_default' => [ 'unit' => 'px', 'size' => 92 ],
			'mobile_default' => [ 'unit' => 'px', 'size' => 84 ],
			'selectors'  => [ '{{WRAPPER}} .wps-story-circle' => '--wps-circle-size: {{SIZE}}{{UNIT}};' ],
		] );

		$this->add_responsive_control( 'circle_gap', [
			'label'      => esc_html__( 'Gap between circles (px)', 'wp-stories' ),
			'type'       => Controls_Manager::SLIDER,
			'size_units' => [ 'px' ],
			'range'      => [ 'px' => [ 'min' => 0, 'max' => 240, 'step' => 2 ] ],
			'default'    => [ 'unit' => 'px', 'size' => 16 ],
			'selectors'  => [ '{{WRAPPER}} .wps-stories-row' => 'gap: {{SIZE}}{{UNIT}};' ],
		] );

		$this->add_responsive_control( 'row_justify_content', [
			'label'     => esc_html__( 'Circle Alignment', 'wp-stories' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => 'flex-start',
			'options'   => [
				'flex-start'    => esc_html__( 'Start', 'wp-stories' ),
				'center'        => esc_html__( 'Center', 'wp-stories' ),
				'flex-end'      => esc_html__( 'End', 'wp-stories' ),
				'space-between' => esc_html__( 'Space Between', 'wp-stories' ),
				'space-around'  => esc_html__( 'Space Around', 'wp-stories' ),
				'space-evenly'  => esc_html__( 'Space Evenly', 'wp-stories' ),
			],
			'selectors' => [ '{{WRAPPER}} .wps-stories-row' => 'justify-content: {{VALUE}};' ],
		] );

		$this->add_responsive_control( 'ring_color_start', [
		...
		$this->add_responsive_control( 'ring_color_end', [
		...
		$this->add_responsive_control( 'ring_width', [
		...
		$this->add_responsive_control( 'ring_gap', [
		...
		$this->add_responsive_control( 'ring_bg_color', [
			'label'       => esc_html__( 'Ring Gap Background Color', 'wp-stories' ),
			'description' => esc_html__( 'Match this to the story row background. Default: #1a1a1a.', 'wp-stories' ),
			'type'        => Controls_Manager::COLOR,
			'default'     => '#1a1a1a',
		...
		$this->add_control( 'avatar_fit', [
			'label'     => esc_html__( 'Avatar Crop', 'wp-stories' ),
			'type'      => Controls_Manager::SELECT,
			'default'   => 'cover',
			'options'   => [
				'cover'      => esc_html__( 'Cover (fill circle, no stretch)', 'wp-stories' ),
			],
			'selectors' => [
				'{{WRAPPER}} .wps-avatar img' => 'object-fit: cover;',
			],
		] );

		$this->add_responsive_control( 'avatar_pos_x', [
			'label'       => esc_html__( 'Horizontal Position (%)', 'wp-stories' ),
			'description' => esc_html__( '0 = left · 50 = center · 100 = right', 'wp-stories' ),
			'type'        => Controls_Manager::SLIDER,
			'size_units'  => [ '%' ],
			'range'       => [ '%' => [ 'min' => 0, 'max' => 100 ] ],
		...
		$this->add_responsive_control( 'avatar_pos_y', [
			'label'       => esc_html__( 'Vertical Position (%)', 'wp-stories' ),
			'description' => esc_html__( '0 = top · 50 = center · 100 = bottom', 'wp-stories' ),
			'type'        => Controls_Manager::SLIDER,
			'size_units'  => [ '%' ],
			'range'       => [ '%' => [ 'min' => 0, 'max' => 100 ] ],
			'default'     => [ 'size' => 50, 'unit' => '%' ],
		...
		$this->add_responsive_control( 'avatar_bg_color', [
			'label'       => esc_html__( 'Avatar Background Color', 'wp-stories' ),
			'description' => esc_html__( 'Visible with transparent PNGs.', 'wp-stories' ),
			'type'        => Controls_Manager::COLOR,
			'default'     => '#333333',
			'selectors'   => [
		...
		$this->add_responsive_control( 'avatar_scale', [
			'label'       => esc_html__( 'Image Scale (%)', 'wp-stories' ),
			'description' => esc_html__( '100 = normal · < 100 = smaller · > 100 = larger (crops)', 'wp-stories' ),
			'type'        => Controls_Manager::SLIDER,
			'size_units'  => [ 'px' ],
		...
		$this->add_control( 'row_scrollbar', [
			'label'   => esc_html__( 'Scrollbar', 'wp-stories' ),
			'type'    => Controls_Manager::SELECT,
			'default' => 'auto',
			'options' => [
				'auto'   => esc_html__( 'Show when needed', 'wp-stories' ),
				'hidden' => esc_html__( 'Hidden', 'wp-stories' ),
			],
			'selectors_dictionary' => [
				'auto'   => '--wps-scrollbar-display: block; --wps-firefox-scrollbar-width: thin;',
				'hidden' => '--wps-scrollbar-display: none; --wps-firefox-scrollbar-width: none;',
			],
			'selectors' => [
				'{{WRAPPER}} .wps-stories-row' => '{{VALUE}}',
			],
		] );
	...
	protected function content_template() {
		...
		_.each( settings.stories, function( story, idx ) {
			var slides = [];
			var imageFit = ['cover', 'contain', 'scale-down'].indexOf(story.image_fit) !== -1 ? story.image_fit : 'cover';
			if ( story.gallery ) {
